@{
    ...
    ModuleToProcess        = 'UpgradePowerShell.psm1'
   ...
   # CompatiblePSEditions = @('Desktop')
    ...
    GUID              = 'd34cbe29-f4e5-46d5-b965-bc40c37eb894'
    ...
    FunctionsToExport = 'Upgrade-PowerShell'
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Upgrade Windows PowerShell from v2 to v5'
